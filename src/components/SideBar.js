...
// import Attendance from "../pages/AddAttandance/Attandance";
...
//   { name: "Attendance", icon: AiOutlineUserAdd, href: "/attendance" }, // Add this line
...
//         <Link to='/'><h1 style={{fontSize:'30px'}}><b>DashBoard</b></h1></Link>
